            ...
            <div class="col" style="width: 300px;">
                <div class="card h-100">
                    ...
                    <div class="card-footer align-items-center justify-content-center">
                        <a href="{{ route('reservas.transfer_crearreservaController', ['valor' => 1]) }}" class="btn btn-primary" name="agendar_aeropuerto_hotel" id="agendar_aeropuerto_hotel">¡Agendar!</a>
                    </div>
                </div>
            </div>
            <div class="col" style="width: 300px;">
                <div class="card h-100">
                    ...
                    <div class="card-footer align-items-center justify-content-center">
                    <a href="{{ route('reservas.transfer_crearreservaController', ['valor' => 2]) }}"  name="agendar_hotel_aeropuerto" id="agendar_hotel_aeropuerto" class="btn btn-primary">¡Agendar!</a>
                    </div>
                </div>
            </div>
            <div class="col" style="width: 300px;">
                <div class="card h-100">
                    ...
                    <div class="card-footer align-items-center justify-content-center">
                    <a href="{{ route('reservas.transfer_crearreservaController', ['valor' => 3]) }}"  name="agendar_completo" id="agendar_completo" class="btn btn-primary">¡Agendar!</a>
                    </div>
                </div>
            </div>
