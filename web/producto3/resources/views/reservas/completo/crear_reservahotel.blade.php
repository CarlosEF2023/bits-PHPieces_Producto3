...
<div class="row justify-content-center mt-5">
    ...
    <div class="phppot-container">
            <h1>Reserva trayecto Hotel al Aeropuerto</h1>
            ...
            <form method="POST" id="checkout-form" action="/~uocx1/controllers/reservas/crear_reserva_sql.php" action="POST">
                ...
                <section id="aeropuerto_hotel">
                    ...
                    <div class="row">
                        <label class="float-left label-width">Aeropueto Destino</label>
                        <input name="aeropuertodestino" id="aeropuertodestino" type="text">
                    </div>
    ...
    <div class="modal-content">
      <div class="modal-header">
        <form name="formulario_modal">
            ...
            <button style="right:0px;top: 5px;" type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
