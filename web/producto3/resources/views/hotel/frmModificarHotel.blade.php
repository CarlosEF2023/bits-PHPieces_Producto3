...
<div class="card" style="width: 60%; margin: 20px auto 0; padding: 30px;">
    <div class="card-body">
       ...
       <br><hr><br>
        <form method="POST" action=" {{route('hotel.updateHotel', $hotel->id_hotel)}}">
        @csrf  
        @method('PUT') 
            ...
            <div class="mb-3 text-center">
                ...
                <a type="button"href="{{ request()->method() === 'GET' ? url()->previous() : url('hotel') }}" class="btn btn-outline-secondary" style="width: auto;" id="cancelar">Volver</a>
            </div>
        </form>
    </div>
</div>
