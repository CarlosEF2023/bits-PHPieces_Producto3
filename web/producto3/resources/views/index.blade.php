    ...
    <header class="navbar navbar-expand-lg navbar-light bg-dark navbar-dark shadow" style="position: sticky; top: 0;">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">
                <?php
                echo "<a href='/index.php'><img src='/assets/Isla_Transfers_Logo.jpeg' width='64px' height='64px'></span></a>";
                ?>
...
<main>
    ...
    <div class="container-fluid" name="principal" id="principal">
        ...
        <div class="hero-section">
            ...
            <p>En Isla Transfer, nos comprometemos a brindar un servicio excepcional, donde la puntualidad y la satisfacción del cliente son nuestras principales prioridades.</p>
            <p>Desde 2010, Sirviendo con Excelencia: Fundada en 2005, Isla Transfer ha crecido para convertirse en uno de los principales proveedores de transferencias de aeropuerto a hotel en nuestra región.</p>
            <p>Comprometidos con la Puntualidad: En Isla Transfer, entendemos la importancia de llegar a tiempo.<br>
                Además, Nuestros conductores profesionales garantizan tiempos de espera mínimos, para que pueda llegar a su destino de manera eficiente y sin demoras.</p>
        </div>

        <div id="reserva" class="reserva-section">
            <h2>Reserva tu transfer</h2>
            <p>¿Listo para reservar su traslado con Isla Transfer?<br>¡Contáctenos hoy mismo para obtener más información!</p>
        ...
        <div class="about-section">
            ...
            <p>Isla Transfers es la empresa líder en traslados de viajeros en la isla. Con una amplia flota de vehículos y un equipo de conductores profesionales, garantizamos un servicio seguro y confiable para nuestros clientes.</p>
            <p>¡Gracias por considerar Isla Transfer para sus necesidades de transferencia aeropuerto-hotel! Esperamos tener el placer de servirle pronto.</p>
        </div>
            ...
            <div class="d-flex justify-content-center" style="margin-top: 50px;">
                <div class="card mx-auto card-index" style="width: 400px;">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">-¡Increíble servicio! Llegaron justo a tiempo y el conductor fue muy amable y servicial.</p>
                    </div>
                </div>
                <div class="card mx-auto card-index" style="width: 400px;">
